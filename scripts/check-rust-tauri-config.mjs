...
expect(mobileTauri.bundle?.android?.versionCode === androidVersionCode(rootVersion), 'Android versionCode should be derived from SemVer.');

expect(manifestValue('apps/mobile/src-tauri/Cargo.toml', 'name') === 'nutrino_mobile', 'Mobile Cargo package name should stay stable.');
expect(manifestValue('apps/desktop/src-tauri/Cargo.toml', 'name') === 'nutrino_desktop', 'Desktop Cargo package name should stay stable.');
expect(manifestValue('apps/mobile/src-tauri/Cargo.toml', 'version') === rootVersion, 'Mobile Cargo version should match root package version.');
expect(manifestValue('apps/desktop/src-tauri/Cargo.toml', 'version') === rootVersion, 'Desktop Cargo version should match root package version.');
expect(cargoLockPackageVersion('apps/mobile/src-tauri/Cargo.lock', 'nutrino_mobile') === rootVersion, 'Mobile Cargo.lock package version should match root package version.');
expect(cargoLockPackageVersion('apps/desktop/src-tauri/Cargo.lock', 'nutrino_desktop') === rootVersion, 'Desktop Cargo.lock package version should match root package version.');
